...
internal class UserStatisticTest{
    ...
    fun addAnswer(){
        ...
        stat.addAnswer(true,10L)
        assertEquals(Base(true,10L),stat.getStatistic(0))
        ...
        assertEquals(Base(true,10L),stat.getStatistic(0))
        assertEquals(Base(true,10L),stat.getStatistic(1))
        assertEquals(Base(true,10L),stat.getStatistic(2))
    }
